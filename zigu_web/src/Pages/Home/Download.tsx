...
export const androidAppStoreLink =
  'https://play.google.com/store/apps/details?id=com.earthmera';
const Container = styled.div<DownloadProps>`
  margin-top: 0px;
  display: flex;
  justify-content: flex-start;
  height: ${props => (props.dropb ? 480 : 350)}px;
  width: ${props => (props.dropb ? 'auto' : '90%')};
  background: linear-gradient(
    299deg,
    rgba(60, 214, 238, 0.44) 0%,
    ${props => (props.dropb ? '#1e1e1e' : '#93FF3F')} 100%
  );
  border-radius: 20px;
