    ...
    steps: [
      {
        ...
        content:
          'Voluntary cleaning by participants can significantly reduce festival cleaning expenditures.',
      },
      {
        image: 'Images/ticketeer3step2.jpeg',
        content:
          'EarthMera can raise environmental awareness among participants who may not respond to traditional cleanup requests on display boards.',
      },
      {
        image: 'Images/ticketeer3step3.jpeg',
        content:
          'Review collected data to use participant engagement and results as indicators for successful green festival operations.',
      },
    ],
  };
  return (
